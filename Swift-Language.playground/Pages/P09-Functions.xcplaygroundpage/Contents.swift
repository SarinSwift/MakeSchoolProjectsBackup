...
var blahBlah = [1, 2, 3, 4, 5, 6]
let resultsOfBlahBlah = firstLast(array: blahBlah)
/*:
...
getArea(height: 10, width: 20)

func getPerimeter(height: Int, width: Int) -> Int {
    return height * 2 + width * 2
}
getPerimeter(height: 10, width: 20)

func irregPerimeter(lengths: [Int]) -> Int {
...
irregPerimeter(lengths: [2, 3, 10, 4, 6])
...
// print(findInstructorBy(prefix: "S"))
// print(findInstructorBy(prefix: "Z"))
