...
*/
var array = ["Wake Up", "Wash the dishes", "Milk the cows" ] //1
array.append("Churn butter") //2
array += ["Call the Cows", "Shear the sheep"] //3
print(array[0]) //4
var currentTask = 0 //5
print(array[currentTask]) //6
currentTask += 1 //7
print(array[currentTask]) //8
array.insert("Feed the chickens", at: 2) //9
currentTask += 1 //10
print(array[currentTask]) //11
print(array) //12
