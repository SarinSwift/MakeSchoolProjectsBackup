 ...
 */
objectCreatedFromExample.myVariable = "Sarin is great!"
anotherExampleObject.myVariable = "What's up you guys"
...
// tigger.name      will print "Tigger"
// tigger.favoriteFood        will print "meat"
tigger.eat(food: "meat")
tigger.eat(food: "kibble")

// tigger.eat(food: "pork")
...
//    }
//}
// func sleep(name: String) -> String {
//     return name + " sleeps for 8 hours."
// }
/*:
 # Testing
